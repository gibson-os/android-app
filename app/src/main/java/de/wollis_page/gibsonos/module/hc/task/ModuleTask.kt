...
object ModuleTask: AbstractTask() {
    ...
    fun index(context: GibsonOsFragment, masterId: Long, start: Long, limit: Long): ListResponse<Module> {
        val dataStore = this.getDataStore(context.activity.getAccount(), "hc", "module", "")
